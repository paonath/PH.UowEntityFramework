...
namespace PH.UowEntityFramework.EntityFramework.Extensions
{
    ...
    {
        [NotNull]
        internal static List<AuditEntry> OnBeforeSaveChanges<TContext>([NotNull] this TContext context, DbSet<Audit.Audit> audits)
        ...
        internal static int OnAfterSaveChanges<TContext>([NotNull] this TContext context, DbSet<Audit.Audit> audits, [CanBeNull] List<AuditEntry> auditEntries)
            where TContext : DbContext, IAuditContext
        {
            if (null == context)
            {
        ...
        private static void OnAfterSaveChangesPrivate<TContext>([NotNull] this TContext context,
                                                                [CanBeNull] List<AuditEntry> auditEntries, [NotNull] DbSet<Audit.Audit> audits)
            where TContext : DbContext, IAuditContext
        {
        ...
        internal static async Task<int> OnAfterSaveChangesAsync<TContext>(
            [NotNull] this TContext context, [NotNull] DbSet<Audit.Audit> audits, [CanBeNull] List<AuditEntry> auditEntries)
            where TContext : DbContext, IAuditContext
        {
            if (null == context)
            {
